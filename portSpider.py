...
allModules = [["http", "Scan for open HTTP ports, and get the the titles."], ["printer", "Scan for open printer ports."], ["gameserver", "Scan for open game server ports."], ["template", "Template module for developers."]]
textToModule = [["http", http], ["template", template], ["printer", printer], ["gameserver", gameserver]]
